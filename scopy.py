        ...
        while True:
            ...
            try:
                ...
                for i in range(int(info[3:6])):   # bond_count
                    line = file.readline()
                    molecule_data.append(tuple(int(line[l: r]) for l, r in [(0,3), (3,6), (6,9)])) # 1st, 2nd atom, bond type
                bond_data.append(molecule_data)                                                    # readability ?
